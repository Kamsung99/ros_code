...
class Move_turtle(Node):
  def __init__(self):
    ...
    self.move_turtle1 = self.create_publisher(Twist, 'turtle1/cmd_vel', qos_profile=self.qos_profile)
    self.move_turtle2 = self.create_publisher(Twist, 'turtle2/cmd_vel', qos_profile=self.qos_profile)
    self.move_turtle3 = self.create_publisher(Twist, 'turtle3/cmd_vel', qos_profile=self.qos_profile)
  ...
  def turtle_move2(self):
    ...
    msg.linear.y = 5.0 * math.cos(self.theta)
    msg.linear.z = 0.0
  ...
  def turtle_move3(self):
    msg = Twist()
    msg.linear.x = 10.0 * math.sin(self.theta) * math.cos(self.theta)
    msg.linear.y = 0.0
    msg.linear.z = 0.0

    msg.angular.x = 0.0
    msg.angular.y = 0.0
    msg.angular.z = self.velocity*10
