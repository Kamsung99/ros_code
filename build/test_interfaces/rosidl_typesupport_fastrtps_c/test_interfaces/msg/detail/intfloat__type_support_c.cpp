...
#include "test_interfaces/msg/detail/intfloat__rosidl_typesupport_fastrtps_c.h"
...
using _Intfloat__ros_msg_type = test_interfaces__msg__Intfloat;
...
size_t get_serialized_size_test_interfaces__msg__Intfloat(
  const void * untyped_ros_message,
...
static uint32_t _Intfloat__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_test_interfaces__msg__Intfloat(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_test_interfaces
size_t max_serialized_size_test_interfaces__msg__Intfloat(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_test_interfaces__msg__Intfloat(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, test_interfaces, msg, Intfloat)() {
