...
{
  new (message_memory) test_interfaces::msg::Intfloat(_init);
}

void Intfloat_fini_function(void * message_memory)
{
  auto typed_message = static_cast<test_interfaces::msg::Intfloat *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Intfloat_message_member_array[2] = {
  {
    ...
    offsetof(test_interfaces::msg::Intfloat, intnum),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_interfaces::msg::Intfloat, floatnum),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Intfloat_message_members = {
  ...
  2,  // number of fields
  sizeof(test_interfaces::msg::Intfloat),
...
get_message_type_support_handle<test_interfaces::msg::Intfloat>()
{
  return &::test_interfaces::msg::rosidl_typesupport_introspection_cpp::Intfloat_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, test_interfaces, msg, Intfloat)() {
  return &::test_interfaces::msg::rosidl_typesupport_introspection_cpp::Intfloat_message_type_support_handle;
}
