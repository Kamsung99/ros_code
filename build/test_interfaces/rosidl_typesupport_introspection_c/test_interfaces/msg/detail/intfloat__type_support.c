...
#include <stddef.h>
#include "test_interfaces/msg/detail/intfloat__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  test_interfaces__msg__Intfloat__init(message_memory);
}

void Intfloat__rosidl_typesupport_introspection_c__Intfloat_fini_function(void * message_memory)
{
  test_interfaces__msg__Intfloat__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Intfloat__rosidl_typesupport_introspection_c__Intfloat_message_member_array[2] = {
  {
    ...
    offsetof(test_interfaces__msg__Intfloat, intnum),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_interfaces__msg__Intfloat, floatnum),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Intfloat__rosidl_typesupport_introspection_c__Intfloat_message_members = {
  ...
  2,  // number of fields
  sizeof(test_interfaces__msg__Intfloat),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_interfaces, msg, Intfloat)() {
